...
contract MasterChefV2 is Ownable, ReentrancyGuard {
    ...
    address public immutable MASTER_CHEF = address(0);
    /// @notice Address of CAKE contract.
    IERC20Metadata public immutable CAKE;
    ...
    uint256 public immutable MASTER_PID = 0;
    ...
    uint256 public MASTERCHEF_CAKE_PER_BLOCK = 0;
    ...
    event AddPool(uint256 indexed pid, uint256 allocPoint, IERC20Metadata indexed lpToken, bool isRegular);
    ...
    event UpdateCakePerBlock(uint256 cakePerBlock);
    ...
    /// @param _MASTERCHEF_CAKE_PER_BLOCK The amount of CAKE to airdrop each block.
    function updateCakePerBlock(
        ...
        emit UpdateCakePerBlock(_MASTERCHEF_CAKE_PER_BLOCK);
    }
